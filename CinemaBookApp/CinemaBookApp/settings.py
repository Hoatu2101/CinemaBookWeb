"""
Django settings for CinemaBookApp project.
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-uew$edm5m)09*8*+$@$*(o!p8^2)7by4k=!n69!s4gnvejs4k7')
...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'CinemaBook.apps.CinemabookConfig', 
    'rest_framework',
    'drf_spectacular',
]
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'CinemaBook API Documentation',
    'DESCRIPTION': 'Hệ thống API Đặt Vé Xem Phim (Cinema Booking System)',
    'VERSION': '1.0.0',
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'CineBook <onboarding@resend.dev>')
# Frontend URL
